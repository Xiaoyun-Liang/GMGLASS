...
%%
%%% Calculating individual-level networks for all subjects of PT group

%%
clear all

load('.../S_indiviudal_negative_rank_PT.mat')
...
figure(1)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV1.mat','SV')
...
figure(2)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV2.mat','SV')
...
figure(3)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV3.mat','SV')
...
figure(4)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV4.mat','SV')
...
figure(5)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV5.mat','SV')
...
figure(6)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV6.mat','SV')
...
figure(7)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV7.mat','SV')
...
figure(8)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV8.mat','SV')
...
figure(9)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV9.mat','SV')
...
figure(10)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV10.mat','SV')
...
figure(11)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV11.mat','SV')
...
figure(12)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV12.mat','SV')
...
figure(13)
imagesc(SV)
save('C:/Work/projects/FMGL/individual/PT_new/SV13.mat','SV')
